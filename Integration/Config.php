...
class Config
{
    ...
    public const FC_EMBED_AUTO = 'auto';
    ...
    public function __construct(
        ...
        if ($integrationObject instanceof AbstractIntegration) {
            ...
            $this->embedType = isset($keys['default_embed_type']) ? $keys['default_embed_type'] : $this::class::FC_EMBED_AUTO;
            $this->loadDelay = isset($keys['load_delay']) ? $keys['load_delay'] : 'timeout';
        }
    }
