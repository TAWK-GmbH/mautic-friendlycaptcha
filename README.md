...
**manual installation**
Download the latests release and extract all files into a folder MauticFriendlyCaptchaBundle / rename the topmost folder (if necessary). Place the folder into the plugins directory of your Mautic installation, clear the cache and press "Install/Upgrade Plugins"
...
**wrapper id**
The wrapper is created by this plugin and holds an id `'mauticform' ~ formName ~ '_' ~ id ~ '_captcha'` e.g. `mauticform_testform_mycaptchaid_captcha`; testform would be the name of your mautic form whereas mycaptchaid the html id that mautic or the form creator gave to the form field.
